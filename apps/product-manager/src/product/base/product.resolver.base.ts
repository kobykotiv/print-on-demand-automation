...
export class ProductResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Print], { name: "print" })
  @nestAccessControl.UseRoles({
    resource: "Print",
    action: "read",
    possession: "any",
  })
  async resolveFieldPrint(
    @graphql.Parent() parent: Product,
    @graphql.Args() args: PrintFindManyArgs
  ): Promise<Print[]> {
    const results = await this.service.findPrint(parent.id, args);
